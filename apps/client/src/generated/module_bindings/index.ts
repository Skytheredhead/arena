...
import AccountSessionRow from "./account_session_table";
...
import PlayerRateLimitRow from "./player_rate_limit_table";
...
const tablesSchema = __schema({
  ...
  account_session: __table({
    name: 'account_session',
    indexes: [
      { accessor: 'token', name: 'account_session_token_idx_btree', algorithm: 'btree', columns: [
        'token',
      ] },
    ],
    constraints: [
      { name: 'account_session_token_key', constraint: 'unique', columns: ['token'] },
    ],
  }, AccountSessionRow),
  ...
  player_input: __table({
    name: 'player_input',
    indexes: [
      { accessor: 'identity', name: 'player_input_identity_idx_btree', algorithm: 'btree', columns: [
        'identity',
      ] },
    ],
    constraints: [
  ...
  player_rate_limit: __table({
    name: 'player_rate_limit',
    indexes: [
      { accessor: 'identity', name: 'player_rate_limit_identity_idx_btree', algorithm: 'btree', columns: [
        'identity',
      ] },
    ],
    constraints: [
      { name: 'player_rate_limit_identity_key', constraint: 'unique', columns: ['identity'] },
    ],
  }, PlayerRateLimitRow),
  ...
  sim_tick_schedule: __table({
    ...
    indexes: [
      { accessor: 'scheduled_id', name: 'sim_tick_schedule_scheduled_id_idx_btree', algorithm: 'btree', columns: [
        'scheduledId',
      ] },
    ],
    constraints: [
      { name: 'sim_tick_schedule_scheduled_id_key', constraint: 'unique', columns: ['scheduledId'] },
    ],
  }, SimTickScheduleRow),
  spawn_point: __table({
    name: 'spawn_point',
  ...
  world_state: __table({
    name: 'world_state',
    indexes: [
      { accessor: 'singleton', name: 'world_state_singleton_idx_btree', algorithm: 'btree', columns: [
        'singleton',
      ] },
    ],
    constraints: [
      { name: 'world_state_singleton_key', constraint: 'unique', columns: ['singleton'] },
    ],
  }, WorldStateRow),
});
...
const reducersSchema = __reducers(
  ...
  __reducerSchema("sim_tick", SimTickReducer),
  __reducerSchema("start_match", StartMatchReducer),
  __reducerSchema("submit_client_state", SubmitClientStateReducer),
